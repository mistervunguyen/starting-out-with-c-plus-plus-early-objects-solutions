// Chapter 17 - Assignment 7, List  search
// This program adds a list search capability to the 
// Linked List Class.
...
int main( )
{
    ...
    cout << "This program demonstrates search of a linked list.";       
    ...
    // Print the list
    cout << "The list you entered is stored as : " << endl;
    list1.rPrint();
    cout << endl;
    ...
    for (int k  = 1; k <= 5; k++)
    {
        cout << "\nEnter a list member to search for by position: ";
        int x;
        cin >> x;
        cout << "\nThe position of " << x << " on the list is " << list1.search(x);         
    }
