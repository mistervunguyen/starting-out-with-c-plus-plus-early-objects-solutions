// Chapter 17, Assignment 11, Generation of Subsets
#include <cstdlib>
#include <list>
#include <vector>
#include <iostream>
...
list<vector<int> > getSubsets(int n)
{
  ...
  // Start with a list of subsets of 1..n that contains on the empty set
  subsetList.push_back(vector<int>()); 

  for (int k = 1; k <= n; k++)
  {
     // temporarily used to extend the subset list
