// Chapter  19 - Assignment 5, Tree Widtth
// This program computes the width of a binary tree.
...
int main()
{
    ...
    // Compute width and report
    cout << endl << "The width of the tree is " << tree1.width();
    cout << endl << "Enter two more values to insert: ";
    int val;
    cout << "?";  cin >> val; tree1.insert(val);
    cout << "?";  cin >> val; tree1.insert(val);
    cout << endl << "The width of the tree is " << tree1.width();   
