// Chapter  19 - Assignment 7, Assignment Operator and Destructor
// This program adds a copy constructor and a destructor to the binary tree.
...
public:
    ...
    BST & BST::operator=(BST &t);  // Assignment operator
...
//***********************************************
//        BST::destroy                          *
// Deallocate all storage for nodes of a tree.  *
//***********************************************
void BST::destroyTree(BTreeNode *t)
{
  if (t !=  NULL)
     {
       destroyTree(t->left);
...
int main( )
{
  ...
  cout << "\nHere is the new tree after reassigning it the value of the old tree:\n";
  newtree = mytree;
  orderedList.clear();
  newtree.inorder(orderedList);
  // Print the inorder list        
